...
<head>
	...
	<link rel="fevicon" href="https://www.flaticon.com/free-icons/blood-bank">
...
{ ?>
			...
			<div class ="notice" style = "background-color:lightgreen;  border-radius:20px;" >
			<marquee behavior="scroll" direction="left">
			<p style ="color:blue;font-size:30px;" class="note text-center mx-auto"> 
			<?php  echo $result->detail; ?> </p></marquee></div>`.
<?php } } } ?>
...
{ ?>
			...
			<div  id = "note" class ="notic" style = "  background-color:lightgreen;border-radius:20px;" >
			<marquee behavior="scroll" direction="left">
			<p style ="color:blue;font-size:30px;" class="note text-center mx-auto"> 
			<?php  echo $result->detail; ?> </p></marquee></div>
<?php } } } ?>
